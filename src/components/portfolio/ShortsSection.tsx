...
export function ShortsSection({
  ...
  return (
    <section
      id={category.id}
      className="relative scroll-mt-24 px-6 py-14 md:px-12 md:py-20"
    >
      ...
      <div className="mx-auto flex max-w-[1600px] gap-3 md:gap-5 overflow-x-auto md:overflow-visible pb-4 md:pb-0">
        {category.items.map((item, i) => {
          ...
          return (
            <motion.div
              ...
              className={`shrink-0 w-[42vw] sm:w-[28vw] md:w-auto md:flex-1 md:min-w-0 ${l.mt}`}
            >
